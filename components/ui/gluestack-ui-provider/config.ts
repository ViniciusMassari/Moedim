...
export const config = {
  light: vars({
    ...
    // Deep blue - primary Jewish color
    '--primary': '220 65% 25%',
    ...
    // Gold accent - for highlights and festivals
    '--accent': '45 90% 50%',
    ...
    '--input': '220 20% 88%',
    '--ring': '220 65% 35%',
    // Custom Jewish theme colors
    '--gold': '45 90% 50%',
    '--gold-light': '45 80% 70%',
    '--gold-dark': '40 85% 40%',
    '--blue-deep': '220 65% 25%',
    '--blue-royal': '220 60% 35%',
  ...
  dark: vars({
    ...
    '--olive': '80 20% 25%',
    '--festival-major': '45 90% 50%',
    '--festival-minor': '220 50% 40%',
    '--shabbat': '220 65% 25%',
    '--sidebar-background': '220 30% 10%',
    '--sidebar-foreground': '45 20% 95%',
    '--sidebar-primary': '45 90% 50%',
    '--sidebar-primary-foreground': '220 40% 13%',
    '--sidebar-accent': '220 40% 20%',
    '--sidebar-accent-foreground': '45 20% 95%',
